...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "employeediscountmanagement/test/integration/FirstJourney",
    "employeediscountmanagement/test/integration/EmployeesListJourney",
    "employeediscountmanagement/test/integration/EmployeesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
