...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("WorkplacesObjectPageObjectPage journey");

        opaTest("Navigate to WorkplacesObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheEmployeesObjectPage.onTable({ property: "Workplaces" }).iCheckRows();
            When.onTheEmployeesObjectPage.onTable({ property: "Workplaces" }).iPressRow(0);

            Then.onTheWorkplacesObjectPage.iSeeThisPage();
        });
