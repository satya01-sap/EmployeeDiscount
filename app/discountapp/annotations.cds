using { DiscountService } from '../../srv/discount-service.cds';

annotate DiscountService.Employees with @UI.DataPoint #firstName: {
  Value: firstName,
  Title: 'First Name',
};
annotate DiscountService.Employees with @UI.DataPoint #lastName: {
  Value: lastName,
  Title: 'Last Name',
};
annotate DiscountService.Employees with @UI.DataPoint #email: {
  Value: email,
  Title: 'Email',
};
annotate DiscountService.Employees with @UI.HeaderFacets: [
...
annotate DiscountService.Employees with @UI.HeaderInfo: {
  TypeName: 'Employee',
  TypeNamePlural: 'Employees',
  Title: { Value: employeeID }
};
annotate DiscountService.Employees with {
  ID @UI.Hidden
};
annotate DiscountService.Employees with @UI.Identification: [{ Value: employeeID }];
...
annotate DiscountService.Employees with @UI.SelectionFields : [
 employeeID,
 firstName,
 lastName,
 email,
...
annotate DiscountService.Employees with @UI.LineItem : [
...
annotate DiscountService.Employees with @UI.FieldGroup #Main: {
...
annotate DiscountService.Workplaces with @UI.LineItem #Employees_Workplaces: [
    { $Type: 'UI.DataField', Value: ID },
...
annotate DiscountService.Cards with @UI.LineItem #Employees_Cards: [
    { $Type: 'UI.DataField', Value: ID },
...
annotate DiscountService.Partners with @UI.LineItem #Employees_Partners: [
    { $Type: 'UI.DataField', Value: ID },
...
annotate DiscountService.Employees with @UI.Facets: [
...
annotate DiscountService.Workplaces with {
...
annotate DiscountService.Workplaces with @UI.DataPoint #workplaceName: {
  Value: workplaceName,
  Title: 'Workplace Name',
};
annotate DiscountService.Workplaces with @UI.HeaderFacets: [
 { $Type : 'UI.ReferenceFacet', Target : '@UI.DataPoint#workplaceName', ID: 'WorkplaceName' }
];
annotate DiscountService.Workplaces with @UI.HeaderInfo: {
  TypeName: 'Workplace',
...
annotate DiscountService.Workplaces with @UI.Identification: [{ Value: workplaceID }];
annotate DiscountService.Workplaces with {
...
annotate DiscountService.Workplaces with @UI.SelectionFields: [
  employees_ID
];
annotate DiscountService.Workplaces with @UI.LineItem: [
    { $Type: 'UI.DataField', Value: ID },
    { $Type: 'UI.DataField', Value: workplaceID },
    { $Type: 'UI.DataField', Value: workplaceName },
    { $Type: 'UI.DataField', Value: region },
...
annotate DiscountService.Workplaces with @UI.FieldGroup #Main: {
  $Type: 'UI.FieldGroupType', Data: [
    { $Type: 'UI.DataField', Value: ID },
    { $Type: 'UI.DataField', Value: workplaceID },
    { $Type: 'UI.DataField', Value: workplaceName },
...
annotate DiscountService.Offers with @UI.LineItem #Workplaces_Offers: [
    { $Type: 'UI.DataField', Value: ID },
...
annotate DiscountService.Partners with @UI.DataPoint #firstName: {
  Value: firstName,
  Title: 'First Name',
};
annotate DiscountService.Partners with @UI.DataPoint #lastName: {
  Value: lastName,
  Title: 'Last Name',
};
annotate DiscountService.Partners with @UI.HeaderFacets: [
 { $Type : 'UI.ReferenceFacet', Target : '@UI.DataPoint#firstName', ID: 'FirstName' },
 { $Type : 'UI.ReferenceFacet', Target : '@UI.DataPoint#lastName', ID: 'LastName' }
];
annotate DiscountService.Partners with @UI.HeaderInfo: {
  TypeName: 'Partner',
...
annotate DiscountService.Partners with @UI.Identification: [{ Value: partnerID }];
annotate DiscountService.Partners with {
...
annotate DiscountService.Partners with @UI.SelectionFields: [
  employees_ID
];
annotate DiscountService.Partners with @UI.LineItem: [
    { $Type: 'UI.DataField', Value: ID },
    { $Type: 'UI.DataField', Value: partnerID },
    { $Type: 'UI.DataField', Value: firstName },
    { $Type: 'UI.DataField', Value: lastName },
...
annotate DiscountService.Partners with @UI.FieldGroup #Main: {
  $Type: 'UI.FieldGroupType', Data: [
    { $Type: 'UI.DataField', Value: ID },
    { $Type: 'UI.DataField', Value: partnerID },
    { $Type: 'UI.DataField', Value: firstName },
...
annotate DiscountService.Partners with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];
annotate DiscountService.Cards with {
  employees @Common.ValueList: {
    CollectionPath: 'Employees',
    Parameters    : [
      {
...
annotate DiscountService.Cards with @UI.DataPoint #cardName: {
  Value: cardName,
  Title: 'Card Name',
};
annotate DiscountService.Cards with @UI.HeaderFacets: [
 { $Type : 'UI.ReferenceFacet', Target : '@UI.DataPoint#cardName', ID: 'CardName' }
];
annotate DiscountService.Cards with @UI.HeaderInfo: {
  TypeName: 'Card',
...
annotate DiscountService.Cards with @UI.Identification: [{ Value: cardNumber }];
annotate DiscountService.Cards with {
...
annotate DiscountService.Cards with @UI.SelectionFields: [
  employees_ID
];
annotate DiscountService.Cards with @UI.LineItem: [
    { $Type: 'UI.DataField', Value: ID },
    { $Type: 'UI.DataField', Value: cardNumber },
    { $Type: 'UI.DataField', Value: cardName },
    { $Type: 'UI.DataField', Value: cardType },
...
annotate DiscountService.Cards with @UI.FieldGroup #Main: {
  $Type: 'UI.FieldGroupType', Data: [
    { $Type: 'UI.DataField', Value: ID },
    { $Type: 'UI.DataField', Value: cardNumber },
    { $Type: 'UI.DataField', Value: cardName },
...
annotate DiscountService.Offers with @UI.LineItem #Cards_Offers: [
    { $Type: 'UI.DataField', Value: ID },
    { $Type: 'UI.DataField', Value: offerID },
    { $Type: 'UI.DataField', Value: offerText },
    { $Type: 'UI.DataField', Value: validFrom },
...
annotate DiscountService.Offers with @UI.DataPoint #offerText: {
  Value: offerText,
  Title: 'Offer Text',
};
annotate DiscountService.Offers with @UI.DataPoint #validFrom: {
  Value: validFrom,
  Title: 'Valid From',
};
annotate DiscountService.Offers with @UI.DataPoint #validTo: {
  Value: validTo,
  Title: 'Valid To',
};
annotate DiscountService.Offers with @UI.HeaderFacets: [
...
annotate DiscountService.Offers with @UI.HeaderInfo: {
  TypeName: 'Offer',
...
annotate DiscountService.Offers with @UI.Identification: [{ Value: offerID }];
annotate DiscountService.Offers with {
...
annotate DiscountService.Offers with @UI.SelectionFields: [
  workplaces_ID,
  cards_ID
];
annotate DiscountService.Offers with @UI.LineItem: [
    { $Type: 'UI.DataField', Value: ID },
    { $Type: 'UI.DataField', Value: offerID },
    { $Type: 'UI.DataField', Value: offerText },
    { $Type: 'UI.DataField', Value: validFrom },
...
annotate DiscountService.Offers with @UI.FieldGroup #Main: {
  $Type: 'UI.FieldGroupType', Data: [
    { $Type: 'UI.DataField', Value: ID },
    { $Type: 'UI.DataField', Value: offerID },
    { $Type: 'UI.DataField', Value: offerText },
...
annotate DiscountService.Offers with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];